...
$htmlContent = $htmlContent.Replace('database.js?v=1.8', 'database.js?v=2.1')
$htmlContent = $htmlContent.Replace('events.js?v=1.8', 'events.js?v=2.1')
$htmlContent = $htmlContent.Replace('game.js?v=1.8', 'game.js?v=2.1')
$htmlContent = $htmlContent.Replace('matchEngine.js?v=1.8', 'matchEngine.js?v=2.1')
$htmlContent = $htmlContent.Replace('styles.css?v=1.8', 'styles.css?v=2.1')
