...
const DATABASE = {
    ...
    PACK_PLAYERS: [
        // Commons (+1 Buffs)
        { id: "kerem", name: "Kerem Aktürkoğlu", rating: 80, pos: "SLK", nation: "🇹🇷", stat: "speed", buff: 1, desc: "+1 Hız kazandırır", bg: "linear-gradient(135deg, #455A64 0%, #1c2833 100%)", tier: "common", isLegend: false, isCommon: true, club: "BEN", stats: { pac: 87, sho: 76, pas: 75, dri: 82, def: 42, phy: 68 }, kit: { primary: "#E53935", secondary: "#FFFFFF", stripe: false }, hair: { color: "#2c1e18", style: "short_fade" }, skin: "#e5b895" },
        { id: "baris", name: "Barış Alper Yılmaz", rating: 80, pos: "SĞK", nation: "🇹🇷", stat: "physical", buff: 1, desc: "+1 Fizik kazandırır", bg: "linear-gradient(135deg, #455A64 0%, #1c2833 100%)", tier: "common", isLegend: false, isCommon: true, club: "GAL", stats: { pac: 89, sho: 74, pas: 71, dri: 80, def: 55, phy: 86 }, kit: { primary: "#E53935", secondary: "#FBC02D", stripe: true }, hair: { color: "#1a120b", style: "buzz" }, skin: "#d9a57a" },
        { id: "semih_k", name: "Semih Kılıçsoy", rating: 78, pos: "SNT", nation: "🇹🇷", stat: "shooting", buff: 1, desc: "+1 Şut kazandırır", bg: "linear-gradient(135deg, #455A64 0%, #1c2833 100%)", tier: "common", isLegend: false, isCommon: true, club: "BJK", stats: { pac: 81, sho: 80, pas: 68, dri: 78, def: 32, phy: 79 }, kit: { primary: "#212121", secondary: "#FFFFFF", stripe: true }, hair: { color: "#1e1e1e", style: "messy" }, skin: "#f0c6a5" },
        { id: "ferdi", name: "Ferdi Kadıoğlu", rating: 81, pos: "SLB", nation: "🇹🇷", stat: "dribbling", buff: 1, desc: "+1 Top Sürme", bg: "linear-gradient(135deg, #455A64 0%, #1c2833 100%)", tier: "common", isLegend: false, isCommon: true, club: "BHA", stats: { pac: 84, sho: 70, pas: 79, dri: 83, def: 77, phy: 76 }, kit: { primary: "#0288D1", secondary: "#FFFFFF", stripe: true }, hair: { color: "#3e2723", style: "wavy" }, skin: "#f2cca8" },
        { id: "szymanski", name: "S. Szymański", rating: 80, pos: "OOS", nation: "🇵🇱", stat: "passing", buff: 1, desc: "+1 Pas", bg: "linear-gradient(135deg, #455A64 0%, #1c2833 100%)", tier: "common", isLegend: false, isCommon: true, club: "FEN", stats: { pac: 79, sho: 78, pas: 82, dri: 81, def: 60, phy: 66 }, kit: { primary: "#FDD835", secondary: "#1A237E", stripe: true }, hair: { color: "#d7b475", style: "parted" }, skin: "#fbe4d0" },
        { id: "nelsson", name: "Victor Nelsson", rating: 80, pos: "STP", nation: "🇩🇰", stat: "defense", buff: 1, desc: "+1 Defans", bg: "linear-gradient(135deg, #455A64 0%, #1c2833 100%)", tier: "common", isLegend: false, isCommon: true, club: "GAL", stats: { pac: 68, sho: 38, pas: 65, dri: 66, def: 83, phy: 82 }, kit: { primary: "#E53935", secondary: "#FBC02D", stripe: true }, hair: { color: "#e8c98e", style: "crop" }, skin: "#fae2d0" },

        // Rare Golds (+2 Buffs)
        { id: "guler", name: "Arda Güler", rating: 84, pos: "OOS", nation: "🇹🇷", stat: "passing", buff: 2, desc: "+2 Pas (+15k Takipçi)", bg: "linear-gradient(135deg, #FFD54F 0%, #8D6E63 50%, #261b14 100%)", tier: "rareGold", isLegend: false, isRareGold: true, club: "RMA", stats: { pac: 78, sho: 80, pas: 86, dri: 87, def: 52, phy: 62 }, kit: { primary: "#FFFFFF", secondary: "#FFD54F", stripe: false }, hair: { color: "#2d1a0e", style: "wavy_fringe" }, skin: "#f0c6a5" },
        { id: "icardi", name: "Mauro Icardi", rating: 83, pos: "SNT", nation: "🇦🇷", stat: "shooting", buff: 2, desc: "+2 Şut kazandırır", bg: "linear-gradient(135deg, #FFD54F 0%, #8D6E63 50%, #261b14 100%)", tier: "rareGold", isLegend: false, isRareGold: true, club: "GAL", stats: { pac: 72, sho: 88, pas: 70, dri: 79, def: 35, phy: 76 }, kit: { primary: "#E53935", secondary: "#FBC02D", stripe: true }, hair: { color: "#f7e394", style: "bleached_undercut" }, skin: "#eec19e" },
        { id: "dzeko", name: "Edin Džeko", rating: 82, pos: "SNT", nation: "🇧🇦", stat: "shooting", buff: 2, desc: "+2 Şut kazandırır", bg: "linear-gradient(135deg, #FFD54F 0%, #8D6E63 50%, #261b14 100%)", tier: "rareGold", isLegend: false, isRareGold: true, club: "FEN", stats: { pac: 60, sho: 84, pas: 74, dri: 75, def: 42, phy: 80 }, kit: { primary: "#FDD835", secondary: "#1A237E", stripe: true }, hair: { color: "#3d2b1f", style: "classic_short" }, skin: "#eed2ba" },
        { id: "muslera", name: "Fernando Muslera", rating: 83, pos: "KL", nation: "🇺🇾", stat: "defense", buff: 2, desc: "+2 Defans kazandırır", bg: "linear-gradient(135deg, #FFD54F 0%, #8D6E63 50%, #261b14 100%)", tier: "rareGold", isLegend: false, isRareGold: true, club: "GAL", stats: { pac: 82, sho: 80, pas: 78, dri: 84, def: 83, phy: 79 }, kit: { primary: "#00C853", secondary: "#1B5E20", stripe: false }, hair: { color: "#1f1a17", style: "swept_back" }, skin: "#ddb088" },
        
        // Elites (+3 Buffs)
        { id: "mbappe", name: "Kylian Mbappé", rating: 91, pos: "SLK", nation: "🇫🇷", stat: "speed", buff: 3, desc: "+3 Hız kazandırır", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "RMA", stats: { pac: 97, sho: 90, pas: 80, dri: 92, def: 36, phy: 78 }, kit: { primary: "#FFFFFF", secondary: "#FFD54F", stripe: false }, hair: { color: "#141414", style: "buzz" }, skin: "#8d5524" },
        { id: "haaland", name: "Erling Haaland", rating: 91, pos: "SNT", nation: "🇳🇴", stat: "shooting", buff: 3, desc: "+3 Şut kazandırır", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "MCI", stats: { pac: 89, sho: 93, pas: 66, dri: 80, def: 45, phy: 88 }, kit: { primary: "#64B5F6", secondary: "#FFFFFF", stripe: false }, hair: { color: "#ffecb3", style: "ponytail" }, skin: "#fae2d0" },
        { id: "messi", name: "Lionel Messi", rating: 90, pos: "SĞK", nation: "🇦🇷", stat: "passing", buff: 3, desc: "+3 Pas kazandırır", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "MIA", stats: { pac: 80, sho: 87, pas: 90, dri: 94, def: 33, phy: 64 }, kit: { primary: "#F48FB1", secondary: "#212121", stripe: false }, hair: { color: "#3e2723", style: "beard_short" }, skin: "#eec19e" },
        { id: "ronaldo", name: "Cristiano Ronaldo", rating: 90, pos: "SNT", nation: "🇵🇹", stat: "shooting", buff: 3, desc: "+3 Şut kazandırır", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "ALN", stats: { pac: 77, sho: 88, pas: 75, dri: 80, def: 34, phy: 75 }, kit: { primary: "#FFD600", secondary: "#1565C0", stripe: false }, hair: { color: "#1a120b", style: "slicked_fade" }, skin: "#c68642" },
        { id: "bellingham", name: "Jude Bellingham", rating: 90, pos: "OS", nation: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", stat: "physical", buff: 3, desc: "+3 Fizik kazandırır", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "RMA", stats: { pac: 80, sho: 86, pas: 83, dri: 88, def: 78, phy: 83 }, kit: { primary: "#FFFFFF", secondary: "#FFD54F", stripe: false }, hair: { color: "#1c1917", style: "textured_taper" }, skin: "#8d5524" },
        { id: "vinicius", name: "Vinicius Jr.", rating: 90, pos: "SLK", nation: "🇧🇷", stat: "dribbling", buff: 3, desc: "+3 Top Sürme", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "RMA", stats: { pac: 95, sho: 84, pas: 81, dri: 91, def: 29, phy: 69 }, kit: { primary: "#FFFFFF", secondary: "#FFD54F", stripe: false }, hair: { color: "#111111", style: "fro_fade" }, skin: "#623b1c" },
        { id: "vandijk", name: "Virgil van Dijk", rating: 89, pos: "STP", nation: "🇳🇱", stat: "defense", buff: 3, desc: "+3 Defans", bg: "radial-gradient(circle at 50% 30%, #FFE082 0%, #FFB300 25%, #212121 70%, #0d1117 100%)", tier: "elite", isLegend: false, club: "LIV", stats: { pac: 78, sho: 60, pas: 71, dri: 72, def: 89, phy: 86 }, kit: { primary: "#D32F2F", secondary: "#FFFFFF", stripe: false }, hair: { color: "#1f1610", style: "top_knot" }, skin: "#a87754" },
        
        // Legends (Icons - +4 or +5 Buffs)
        { id: "pele", name: "Pelé", rating: 95, pos: "SNT", nation: "🇧🇷", stat: "shooting", buff: 5, desc: "+5 Şut (Efsane)", bg: "radial-gradient(circle at 50% 25%, #E1BEE7 0%, #7B1FA2 30%, #311B92 70%, #070014 100%)", tier: "legend", isLegend: true, club: "BRA", stats: { pac: 95, sho: 96, pas: 93, dri: 96, def: 60, phy: 76 }, kit: { primary: "#FFEB3B", secondary: "#388E3C", stripe: false }, hair: { color: "#141414", style: "retro_part" }, skin: "#593110" },
        { id: "maradona", name: "Diego Maradona", rating: 95, pos: "OOS", nation: "🇦🇷", stat: "dribbling", buff: 5, desc: "+5 Top Sürme (Efsane)", bg: "radial-gradient(circle at 50% 25%, #E1BEE7 0%, #7B1FA2 30%, #311B92 70%, #070014 100%)", tier: "legend", isLegend: true, club: "ARG", stats: { pac: 92, sho: 93, pas: 92, dri: 97, def: 40, phy: 76 }, kit: { primary: "#81D4FA", secondary: "#FFFFFF", stripe: true }, hair: { color: "#181818", style: "afro_curls" }, skin: "#d99b66" },
        { id: "ronaldinho", name: "Ronaldinho", rating: 93, pos: "SLK", nation: "🇧🇷", stat: "dribbling", buff: 4, desc: "+4 Top Sürme (Efsane)", bg: "radial-gradient(circle at 50% 25%, #E1BEE7 0%, #7B1FA2 30%, #311B92 70%, #070014 100%)", tier: "legend", isLegend: true, club: "BRA", stats: { pac: 91, sho: 85, pas: 90, dri: 95, def: 37, phy: 79 }, kit: { primary: "#FFEB3B", secondary: "#388E3C", stripe: false }, hair: { color: "#121212", style: "headband_curls" }, skin: "#8d5524" },
        { id: "zidane", name: "Zinédine Zidane", rating: 94, pos: "OOS", nation: "🇫🇷", stat: "passing", buff: 4, desc: "+4 Pas (Efsane)", bg: "radial-gradient(circle at 50% 25%, #E1BEE7 0%, #7B1FA2 30%, #311B92 70%, #070014 100%)", tier: "legend", isLegend: true, club: "FRA", stats: { pac: 83, sho: 88, pas: 96, dri: 95, def: 75, phy: 86 }, kit: { primary: "#1565C0", secondary: "#FFFFFF", stripe: false }, hair: { color: "#544943", style: "bald_crown" }, skin: "#f0c6a5" },
        { id: "maldini", name: "Paolo Maldini", rating: 92, pos: "STP", nation: "🇮🇹", stat: "defense", buff: 4, desc: "+4 Defans (Efsane)", bg: "radial-gradient(circle at 50% 25%, #E1BEE7 0%, #7B1FA2 30%, #311B92 70%, #070014 100%)", tier: "legend", isLegend: true, club: "MIL", stats: { pac: 86, sho: 56, pas: 75, dri: 70, def: 96, phy: 85 }, kit: { primary: "#D32F2F", secondary: "#212121", stripe: true }, hair: { color: "#2d1c14", style: "flowing_long" }, skin: "#eec19e" }
    ],
